...
test_pw_hash = BCrypt::Password.create(test_password)

user_array = 10.times.collect do User.create!(username: Faker::HarryPotter.character, email: Faker::Internet.safe_email, pw_hash: test_pw_hash)
end
